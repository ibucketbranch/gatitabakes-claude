...
<main>
  <div class="order-form-main-card">
    ...
    <!-- Product Grid -->
    <div class="product-grid compact-scroll">
      <?php foreach (
        $PRODUCTS as $id => $product): ?>
      <div class="product-card">
        <img src="<?php echo IMAGES_PATH . '/' . $product['image']; ?>" alt="<?php echo $product['name']; ?>">
    ...
    <div class="order-form-flex">
      <form id="order-form" class="order-form card">
        <!-- Step 1: Order Type -->
        <div class="form-section step" id="step-1">
          <h2>How would you like to get your order?</h2>
          <div class="order-type-options">
            <label class="order-type-option">
              <input type="radio" id="pickup" name="order_type" value="pickup"> Pickup
            </label>
            <label class="order-type-option">
